...
e = c.inverse
puts "2+3. De inverse is [[#{e[0,0].to_i},#{e[0,1].to_i}],[#{e[1,0].to_i},#{e[1,1].to_i}]]"
f= d*e
...
puts "     Omgezet naar letters word dit #{numberToLetter( g[0,0].to_i)}#{numberToLetter( g[0,1].to_i)}#{numberToLetter( g[1,0].to_i)}#{numberToLetter( g[1,1].to_i)}"